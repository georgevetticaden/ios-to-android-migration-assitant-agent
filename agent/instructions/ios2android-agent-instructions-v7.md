...
2. "Wait 5 seconds for app to fully load"
3. "Verify you see chat list in left panel"
4. "Look for three dots (⋮) menu at top right of screen"
5. "Click coordinates: 1350, 160"
6. "Wait 2 seconds for menu to appear"
7. "Select 'New group' from menu"
8. "Wait 3 seconds for group creation screen"
9. "Click the Search field at top"
10. "Type: [first family member name from database]"
11. "Wait 2 seconds for search results"
12. "If contact appears, tap to select (checkmark appears)"
13. "Click the X to clear search field"
14. "Type: [second family member name from database]"
15. "Wait 2 seconds for search results"
16. "If contact appears, tap to select (checkmark appears)"
17. "Click the X to clear search field"
18. "Type: [third family member name from database]"
19. "Wait 2 seconds for search results"
20. "If contact appears, tap to select (checkmark appears)"
21. "Click the X to clear search field"
22. "Type: [fourth family member name from database]"
23. "Wait 2 seconds for search results"
24. "If contact appears, tap to select (checkmark appears)"
25. "Count selected members shown at top of screen"
26. "Click green arrow at bottom right"
27. "Wait 2 seconds for next screen"
28. "Type group name: [group_name from database]"
29. "Click green checkmark to create group"
30. "Wait 3 seconds for group to be created"
31. "Verify group shows all added members"
32. "Return: Found and added: [list]. Not found: [list]"
</critical_mobile_sequence>
